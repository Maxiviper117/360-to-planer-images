...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>No</td>
      <td>90 degrees (straight ahead)</td>
    ...
    <tr>
      ...
      <td>Takes a list of yaw angles (rotation around the vertical axis - left/right) in degrees. Each yaw angle in the list will generate a separate output image, simulating rotation around the panorama.</br><code>0</code> degrees corresponds to the front view, and positive angles rotate to the right.
      </td>
    </tr>
  </tbody>
</table>
