...
1. **Using the Compiled Executable**: For users who prefer a straightforward approach without setting up a Python environment.
2. **Running the Python Script**: For users who want to run the code directly or modify it.
